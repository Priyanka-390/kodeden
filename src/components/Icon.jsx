export const Callicon = () => {
  return (
    ...
    >
      <path
        d="M20.814 11.3628H22.814C22.814 6.23277 18.941 2.36377 13.804 2.36377V4.36377C17.866 4.36377 20.814 7.30677 20.814 11.3628Z"
        fill="#F4F4F4"
      />
      <path
        d="M13.816 8.36401C15.919 8.36401 16.816 9.26101 16.816 11.364H18.816C18.816 8.13901 17.041 6.36401 13.816 6.36401V8.36401ZM17.238 13.807C17.0458 13.6324 16.7933 13.5392 16.5338 13.5472C16.2742 13.5553 16.028 13.6638 15.847 13.85L13.454 16.311C12.878 16.201 11.72 15.84 10.528 14.651C9.33596 13.458 8.97496 12.297 8.86796 11.725L11.327 9.33101C11.5134 9.15014 11.6221 8.90383 11.6301 8.64422C11.6381 8.3846 11.5448 8.13205 11.37 7.94001L7.67496 3.87701C7.5 3.68437 7.25683 3.56751 6.99711 3.55127C6.73738 3.53502 6.48155 3.62067 6.28396 3.79001L4.11396 5.65101C3.94107 5.82452 3.83788 6.05546 3.82396 6.30001C3.80896 6.55001 3.52296 12.472 8.11496 17.066C12.121 21.071 17.139 21.364 18.521 21.364C18.723 21.364 18.847 21.358 18.88 21.356C19.1245 21.3423 19.3553 21.2387 19.528 21.065L21.388 18.894C21.5574 18.6965 21.6432 18.4408 21.6272 18.1811C21.6111 17.9213 21.4945 17.6781 21.302 17.503L17.238 13.807Z"
        fill="#F4F4F4"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        ...
        fill="url(#paint0_linear_2_1896)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_2_1896"
          x1="4.35849"
          y1="-5.36205e-08"
          x2="29.9811"
          y2="29.717"
...
export const Rightarrow = () => {
  return (
    ...
    >
      <path
        d="M0.200781 3.0001L6.20078 9.0001L0.200781 15.0001L1.40078 17.4001L9.80078 9.0001L1.40078 0.600098L0.200781 3.0001Z"
        fill="#F4F4F4"
      />
    </svg>
  );
...
export const Cardarrow = () => {
  return (
    ...
    >
      <path
        d="M14.5085 3.41614L8.87116 6.67088V0.161393L14.5085 3.41614ZM9.4349 3.97988H0.978826V2.8524H9.4349V3.97988Z"
        fill="#E4E4E4"
      />
    </svg>
  );
      ...
      <defs>
        ...
        <clipPath id="clip0_2_1985">
          <rect
            ...
            height="18.9831"
            fill="white"
            transform="translate(8.70142 8.70056)"
          />
        </clipPath>
      </defs>
    </svg>
  ...
  return (
    ...
    >
      <rect
        ...
        fill="white"
        fillOpacity="0.05"
        stroke="url(#paint0_linear_2_1997)"
        strokeWidth="0.790962"
      />
      <path
        d="M26.6253 12.8537L24.1189 24.6736C23.9297 25.5077 23.4367 25.7153 22.7361 25.3226L18.917 22.5084L17.0744 24.2809C16.8704 24.485 16.7001 24.6552 16.3068 24.6552L16.5815 20.7661L23.6592 14.3706C23.9671 14.0965 23.5922 13.944 23.1811 14.2187L14.4311 19.7285L10.6641 18.5492C9.84486 18.2935 9.83003 17.73 10.8349 17.3367L25.5688 11.6601C26.251 11.4045 26.8478 11.812 26.6253 12.8543V12.8537Z"
        fill="url(#paint1_linear_2_1997)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_2_1997"
          x1="-0.000244235"
          y1="1.56738"
          x2="17.0033"
          y2="27.1886"
  ...
  return (
    ...
    >
      <rect
        ...
        fill="white"
        fillOpacity="0.05"
        stroke="url(#paint0_linear_2_2003)"
        strokeWidth="0.790962"
      />
      <path
        d="M12.4633 14.282C13.3696 14.282 14.1043 13.5473 14.1043 12.641C14.1043 11.7347 13.3696 11 12.4633 11C11.557 11 10.8223 11.7347 10.8223 12.641C10.8223 13.5473 11.557 14.282 12.4633 14.282Z"
        fill="url(#paint1_linear_2_2003)"
      />
      <path
        d="M14.1046 16.7436H10.8225V27H14.1046V16.7436Z"
        fill="url(#paint2_linear_2_2003)"
      />
      <path
        d="M17.386 20.641V27H20.2578V21.2564C20.2578 20.2308 20.8732 19.4103 21.8988 19.4103C22.9244 19.4103 23.5398 20.4359 23.5398 21.2564V27H26.4116V20.641C26.4116 19.4103 24.9757 16.7436 21.8988 16.7436C18.8219 16.7436 17.386 19.4103 17.386 20.641Z"
